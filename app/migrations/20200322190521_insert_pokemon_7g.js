...
const POKEMON_FILE = path.join(POKEMON_DIR, "7-gen.json");
...
const insert7thGenPokemons = async knex => {
...
const delete7thGenPokemons = async knex => {
...
exports.up = async knex => {
  await insert7thGenPokemons(knex);
};

exports.down = async knex => {
  await delete7thGenPokemons(knex);
};
